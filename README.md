...
## Dataset
The datasets can be downloaded [here](https://drive.google.com/drive/folders/15XpRyjwZOTnOMbTgsaWfAe30SlPsYEg-?usp=sharing). It includes datasets for our APP-BMao, datasets for GEDGNN, datasets from pyg and datasets for SDTED.
